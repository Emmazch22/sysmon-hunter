#!/usr/bin/env python3
"""Build the local ATT&CK technique lookup.
...
official dataset, and writes a small JSON keyed by ATT&CK ID containing only the
techniques the project uses. That file is committed and served by the backend.

    python scripts/fetch_attack.py

The result lands at backend/data/attack_data.json.
"""
